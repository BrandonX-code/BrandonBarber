...
{
    public partial class DetalleAdminPage : ContentPage
    {
        public DetalleAdminPage(UsuarioModels barbero)
        {
            InitializeComponent();

            // Configurar los datos
            BindingContext = new DetallesAdminViewModel(barbero);
        }
    ...
    public class DetallesAdminViewModel
    {
        ...
        public DetallesAdminViewModel(UsuarioModels barbero)
        {
